    ...
    <div className="w-full h-screen text-white flex flex-col justify-center items-center">
      <div className="flex flex-col justify-center items-center">
        ...
        <form onSubmit={(e)=> e.preventDefault()} className="flex flex-col border-[1px] border-gray-700 p-10 rounded-lg w-1/2 h-fit mt-5">
            ...
            <button type="submit" className="w-full bg-[#dfe2e5] mt-10 p-2 rounded-md text-black">Signin</button>

            <Link to={'/register'} className="underline text-[#7f8ea3] mt-5 text-center p-5">Don't have an account? Sign up</Link>
        </form>
